function [index, score] = OneDollar_Recognizer(INK_Data,TrainingData)
    
    N = 64;
    Templates = zeros(N,2,10);
    ...
    [score,index] = Recognize(Data,Templates,Size);
    ...
    function [score, index] = Recognize(Points,templates,Size)
        b = inf;
        index = 0;
        Theta = pi/4;
